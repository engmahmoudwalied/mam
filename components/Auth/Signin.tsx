            ...
            <form>
              ...
              <div className="flex flex-wrap items-center gap-10 md:justify-between xl:gap-15">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2.5 rounded-md bg-black px-6 py-3 font-medium text-white duration-300 ease-in-out hover:bg-blackho dark:bg-btndark dark:hover:bg-blackho"
                >
                  Log in
                  <svg
