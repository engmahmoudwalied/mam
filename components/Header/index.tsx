...
// app/custom-components/profile/page.js
    ...
    >
      <div className="relative items-center justify-between px-4 mx-auto max-w-c-1390 md:px-8 xl:flex 2xl:px-0">
        <div className="flex items-center justify-between w-full xl:w-1/4">
          <a href="/">
          {/* In the future, I will add logo */}
            <Image
              src="/images/logo/logo-dark.ico"
              alt="logo"
              width={100}
              height={30}
            ...
            /> 
            <Image
              src="/images/logo/logo-light.ico"
              alt="logo"
              width={100}
              height={30}
        ...
        >
          ...
          <div className="flex items-center gap-6 mt-7 xl:mt-0">
            ...
            <Link
              ...
              className="flex items-center justify-center rounded-md bg-primary px-7.5 py-3 text-regular text-white duration-300 ease-in-out hover:bg-primaryho"
            >
              Get Started
            </Link>
          </div>
