...
export const Editor = observer(() => {
  ...
  return (
    <div className="grid grid-rows-[500px_1fr_20px] grid-cols-[72px_300px_1fr_250px] h-[100svh]">
      ...
      <div className="flex flex-col row-span-2 tile">
        <Menu />
      </div>
      <div className="flex flex-col row-span-2 overflow-scroll">
        <Resources />
      </div>
      <div id="grid-canvas-container" className="flex items-center justify-center col-start-3 bg-slate-100">
