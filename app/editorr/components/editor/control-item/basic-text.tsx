          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="relative">
                ...
                <div className="absolute right-2.5 top-1/2 -translate-y-1/2 transform text-sm text-zinc-200">
                  px
                </div>
              </div>
            </div>
...
const Fill = () => {
  return (
    ...
    >
      <div className="flex items-center  text-sm text-zinc-500">Fill</div>
      <div>
        <div className="h-6 w-6 rounded-sm border-2 border-zinc-800 bg-green-700"></div>
      </div>
      <div>
...
const Stroke = () => {
  return (
    ...
    >
      <div className="flex items-center  text-sm text-zinc-500">Stroke</div>
      <div>
        <div className="h-6 w-6 rounded-sm border-2 border-zinc-800 bg-green-700"></div>
      </div>
      <div>
...
const Shadow = () => {
  return (
    ...
    >
      <div className="flex items-center  text-sm text-zinc-500">Shadow</div>
      <div>
        <div className="h-6 w-6 rounded-sm border-2 border-zinc-800 bg-green-700"></div>
      </div>
      <div>
...
const Background = () => {
  return (
    ...
    >
      <div className="flex items-center  text-sm text-zinc-500">Background</div>
      <div>
        <div className="h-6 w-6 rounded-sm border-2 border-zinc-800 bg-green-700"></div>
      </div>
      <div>
